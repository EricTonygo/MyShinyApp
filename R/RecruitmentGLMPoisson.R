RecruitmentGLMPoisson <- function(DataFormatted,ParamFiles,criterion="BIC"){
  ...
  FormatDataRecruitmentGLMPoisson <- function(Data,ClassesDiam,NbClasse,Surface,CDSTB){
    library(data.table)
  ...
  # Formatting Data      
  DataR=FormatDataRecruitmentGLMPoisson(DataFormatted$ClusteringData,ClassesDiam,NbClasse,Surface,SimRecrut$CDSTB)
  DataRecrut=DataR$outRecruts
  DataRecrut2=DataR$outRecrutsPred
  
  res=glm(modelRecrut,data=DataRecrut,family="poisson")
